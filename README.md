# AAStar Start
面向最终用户、开发者或者社区运营者的 Start 展示产品，我们构建了几个产品：CryptoNewbieShuttle、CoinJar 和 CommunityTapWater（未来会迭代推出），分别面向加密新手、小额支付场景和社区运营者，提供简单易用的痛点解决方案。我们会针对典型场景对比的方式，来展示基于 AirAccount、SuperPaymaster 和 COS72 的解决方案。
