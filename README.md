# AAStar Start
当前项目还是一个 mock 项目，目的是展示和梳理基于我们 sdk 可以构建的基础应用，包括 C 端、KOL、商家和社区运营者，面向这些用户展示产品，我们构建了几个产品：CryptoNewbieShuttle、CoinJar、Spores 和 CommunityTapWater，分别面向加密新手难题、商家小额接收加密货币和商家按效果付费集客、社区运营可持续，提供简单易用的痛点解决方案。我们会针对典型场景对比的方式，来展示基于 AirAccount、SuperPaymaster 和 COS72 以及系列基础协议支持的解决方案。

A breakdown of the product suite is presented below, outlining solutions for various user segments within the cryptocurrency ecosystem.
